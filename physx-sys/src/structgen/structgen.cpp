...
int main() {
    ...
    struct physx_PxSocket_Pod: public physx::PxSocket {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxSocket_Pod", "PxSocket");
            sg.end_struct(sizeof(physx::PxSocket));
        }
    };
    physx_PxSocket_Pod::dump_layout(sg);
    ...
    struct physx_PxThreadImpl_Pod: public physx::PxThreadImpl {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxThreadImpl_Pod", "PxThreadImpl");
            sg.end_struct(sizeof(physx::PxThreadImpl));
        }
    };
    physx_PxThreadImpl_Pod::dump_layout(sg);
    ...
    sg.pass_thru("struct physx_PxDeformableSurfaceMaterial_Pod;\n");
    sg.pass_thru("struct physx_PxDeformableVolumeMaterial_Pod;\n");
    ...
    sg.pass_thru("struct physx_PxDeformableSurface_Pod;\n");
    sg.pass_thru("struct physx_PxDeformableVolume_Pod;\n");
    sg.pass_thru("struct physx_PxDeformableAttachment_Pod;\n");
    sg.pass_thru("struct physx_PxDeformableElementFilter_Pod;\n");
    ...
    struct physx_PxReportCallbackBase_Pod: public physx::PxReportCallbackBase {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxReportCallbackBase_Pod", "PxReportCallbackBase");
            sg.add_field("uint32_t mCapacity", "mCapacity", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxReportCallbackBase_Pod, mCapacity));
            sg.add_field("uint32_t mSize", "mSize", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxReportCallbackBase_Pod, mSize));
            sg.end_struct(sizeof(physx::PxReportCallbackBase));
        }
    };
    physx_PxReportCallbackBase_Pod::dump_layout(sg);
    ...
    sg.pass_thru("struct physx_PxMultiCallback_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxPBDParticleSystem_Pod {\n    void* vtable_;\n};\n");
    ...
    struct physx_PxGeomIndexClosePair_Pod: public physx::PxGeomIndexClosePair {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxGeomIndexClosePair_Pod", "PxGeomIndexClosePair");
            sg.add_field("float distance", "distance", "f32", sizeof(float), unsafe_offsetof(physx_PxGeomIndexClosePair_Pod, distance));
            sg.end_struct(sizeof(physx::PxGeomIndexClosePair));
        }
    };
    physx_PxGeomIndexClosePair_Pod::dump_layout(sg);
    ...
    struct physx_PxConvexCoreGeometry_Pod: public physx::PxConvexCoreGeometry {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxConvexCoreGeometry_Pod", "PxConvexCoreGeometry");
            sg.end_struct(sizeof(physx::PxConvexCoreGeometry));
        }
    };
    physx_PxConvexCoreGeometry_Pod::dump_layout(sg);
    ...
    struct physx_PxHeightFieldDesc_Pod: public physx::PxHeightFieldDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxBoundedData_Pod samples", "samples", "PxBoundedData", sizeof(physx::PxBoundedData), unsafe_offsetof(physx_PxHeightFieldDesc_Pod, samples));
    ...
    sg.pass_thru("struct physx_PxDeformableVolumeAuxData_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxTetrahedronMesh_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableVolumeMesh_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxCollisionMeshMappingData_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxDeformableVolumeCollisionData_Pod: public physx::PxDeformableVolumeCollisionData {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableVolumeCollisionData_Pod", "PxDeformableVolumeCollisionData");
            sg.end_struct(sizeof(physx::PxDeformableVolumeCollisionData));
        }
    };
    physx_PxDeformableVolumeCollisionData_Pod::dump_layout(sg);
    ...
    struct physx_PxDeformableVolumeSimulationData_Pod: public physx::PxDeformableVolumeSimulationData {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableVolumeSimulationData_Pod", "PxDeformableVolumeSimulationData");
            sg.end_struct(sizeof(physx::PxDeformableVolumeSimulationData));
        }
    };
    physx_PxDeformableVolumeSimulationData_Pod::dump_layout(sg);
    ...
    struct physx_Px1DConstraintFlag_Pod: public physx::Px1DConstraintFlag {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_Px1DConstraintFlag_Pod", "Px1DConstraintFlag");
            sg.end_struct(sizeof(physx::Px1DConstraintFlag));
        }
    };
    physx_Px1DConstraintFlag_Pod::dump_layout(sg);
    ...
    struct physx_Px1DConstraint_Pod: public physx::Px1DConstraint {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("uint32_t pad", "pad", "u32", sizeof(uint32_t), unsafe_offsetof(physx_Px1DConstraint_Pod, pad));
    ...
    struct physx_PxSolverBodyData_Pod: public physx::PxSolverBodyData {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("uint32_t pad", "pad", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxSolverBodyData_Pod, pad));
    ...
    struct physx_PxSolverConstraintDesc_Pod: public physx::PxSolverConstraintDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("void* writeBackFriction", "writeBackFriction", "*mut std::ffi::c_void", sizeof(void*), unsafe_offsetof(physx_PxSolverConstraintDesc_Pod, writeBackFriction));
    ...
    struct physx_PxSolverContactDesc_Pod: public physx::PxSolverContactDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxContactPoint_Pod const* contacts", "contacts", "*const PxContactPoint", sizeof(physx::PxContactPoint const*), unsafe_offsetof(physx_PxSolverContactDesc_Pod, contacts));
    ...
    struct physx_PxPerformanceEnvelope_Pod: public physx::PxPerformanceEnvelope {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxPerformanceEnvelope_Pod", "PxPerformanceEnvelope");
            sg.add_field("float maxEffort", "maxEffort", "f32", sizeof(float), unsafe_offsetof(physx_PxPerformanceEnvelope_Pod, maxEffort));
            sg.add_field("float maxActuatorVelocity", "maxActuatorVelocity", "f32", sizeof(float), unsafe_offsetof(physx_PxPerformanceEnvelope_Pod, maxActuatorVelocity));
            sg.add_field("float velocityDependentResistance", "velocityDependentResistance", "f32", sizeof(float), unsafe_offsetof(physx_PxPerformanceEnvelope_Pod, velocityDependentResistance));
            sg.add_field("float speedEffortGradient", "speedEffortGradient", "f32", sizeof(float), unsafe_offsetof(physx_PxPerformanceEnvelope_Pod, speedEffortGradient));
            sg.end_struct(sizeof(physx::PxPerformanceEnvelope));
        }
    };
    physx_PxPerformanceEnvelope_Pod::dump_layout(sg);

    struct physx_PxJointFrictionParams_Pod: public physx::PxJointFrictionParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxJointFrictionParams_Pod", "PxJointFrictionParams");
            sg.add_field("float staticFrictionEffort", "staticFrictionEffort", "f32", sizeof(float), unsafe_offsetof(physx_PxJointFrictionParams_Pod, staticFrictionEffort));
            sg.add_field("float dynamicFrictionEffort", "dynamicFrictionEffort", "f32", sizeof(float), unsafe_offsetof(physx_PxJointFrictionParams_Pod, dynamicFrictionEffort));
            sg.add_field("float viscousFrictionCoefficient", "viscousFrictionCoefficient", "f32", sizeof(float), unsafe_offsetof(physx_PxJointFrictionParams_Pod, viscousFrictionCoefficient));
            sg.end_struct(sizeof(physx::PxJointFrictionParams));
        }
    };
    physx_PxJointFrictionParams_Pod::dump_layout(sg);
    ...
    struct physx_PxArticulationDrive_Pod: public physx::PxArticulationDrive {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxPerformanceEnvelope_Pod envelope", "envelope", "PxPerformanceEnvelope", sizeof(physx::PxPerformanceEnvelope), unsafe_offsetof(physx_PxArticulationDrive_Pod, envelope));
    ...
    struct physx_PxTGSSolverBodyTxInertia_Pod: public physx::PxTGSSolverBodyTxInertia {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxQuat_Pod deltaBody2WorldQ", "deltaBody2WorldQ", "PxQuat", sizeof(physx::PxQuat), unsafe_offsetof(physx_PxTGSSolverBodyTxInertia_Pod, deltaBody2WorldQ));
            sg.add_field("physx_PxVec3_Pod body2WorldP", "body2WorldP", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxTGSSolverBodyTxInertia_Pod, body2WorldP));
    ...
    struct physx_PxTGSSolverConstraintPrepDescBase_Pod: public physx::PxTGSSolverConstraintPrepDescBase {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxSolverContactDesc::BodyState_Pod bodyState0", "bodyState0", "PxSolverContactDesc::BodyState", sizeof(physx::PxSolverContactDesc::BodyState), unsafe_offsetof(physx_PxTGSSolverConstraintPrepDescBase_Pod, bodyState0));
            sg.add_field("physx_PxSolverContactDesc::BodyState_Pod bodyState1", "bodyState1", "PxSolverContactDesc::BodyState", sizeof(physx::PxSolverContactDesc::BodyState), unsafe_offsetof(physx_PxTGSSolverConstraintPrepDescBase_Pod, bodyState1));
    ...
    struct physx_PxTGSSolverContactDesc_Pod: public physx::PxTGSSolverContactDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxContactPoint_Pod const* contacts", "contacts", "*const PxContactPoint", sizeof(physx::PxContactPoint const*), unsafe_offsetof(physx_PxTGSSolverContactDesc_Pod, contacts));
    ...
    sg.pass_thru("struct physx_PxArticulationSpatialTendon_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxArticulationFixedTendon_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxArticulationMimicJoint_Pod: public physx::PxArticulationMimicJoint {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxArticulationMimicJoint_Pod", "PxArticulationMimicJoint");
            sg.add_field("void* userData", "userData", "*mut std::ffi::c_void", sizeof(void*), unsafe_offsetof(physx_PxArticulationMimicJoint_Pod, userData));
            sg.end_struct(sizeof(physx::PxArticulationMimicJoint));
        }
    };
    physx_PxArticulationMimicJoint_Pod::dump_layout(sg);
    ...
    struct physx_PxArticulationCache_Pod: public physx::PxArticulationCache {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("float* coriolisForce", "coriolisForce", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, coriolisForce));
            sg.add_field("float* gravityCompensationForce", "gravityCompensationForce", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, gravityCompensationForce));
            sg.add_field("float* centroidalMomentumMatrix", "centroidalMomentumMatrix", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, centroidalMomentumMatrix));
            sg.add_field("float* centroidalMomentumBias", "centroidalMomentumBias", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, centroidalMomentumBias));
            ...
            sg.add_field("float* jointTargetPositions", "jointTargetPositions", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, jointTargetPositions));
            sg.add_field("float* jointTargetVelocities", "jointTargetVelocities", "*mut f32", sizeof(float*), unsafe_offsetof(physx_PxArticulationCache_Pod, jointTargetVelocities));
            ...
            sg.add_field("physx_PxSpatialForce_Pod* linkIncomingJointForce", "linkIncomingJointForce", "*mut PxSpatialForce", sizeof(physx::PxSpatialForce*), unsafe_offsetof(physx_PxArticulationCache_Pod, linkIncomingJointForce));
            sg.add_field("physx_PxVec3_Pod* linkForce", "linkForce", "*mut PxVec3", sizeof(physx::PxVec3*), unsafe_offsetof(physx_PxArticulationCache_Pod, linkForce));
            sg.add_field("physx_PxVec3_Pod* linkTorque", "linkTorque", "*mut PxVec3", sizeof(physx::PxVec3*), unsafe_offsetof(physx_PxArticulationCache_Pod, linkTorque));
    ...
    struct physx_PxContactPatch_Pod: public physx::PxContactPatch {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxConstraintInvMassScale_Pod mMassModification", "mMassModification", "PxConstraintInvMassScale", sizeof(physx::PxConstraintInvMassScale), unsafe_offsetof(physx_PxContactPatch_Pod, mMassModification));
    ...
    struct physx_PxFrictionPatch_Pod: public physx::PxFrictionPatch {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxFrictionPatch_Pod", "PxFrictionPatch");
            sg.add_field("physx_PxVec3_Pod anchorPositions[2]", "anchorPositions", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxFrictionPatch_Pod, anchorPositions));
            sg.add_field("physx_PxVec3_Pod anchorImpulses[2]", "anchorImpulses", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxFrictionPatch_Pod, anchorImpulses));
            sg.add_field("uint32_t anchorCount", "anchorCount", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxFrictionPatch_Pod, anchorCount));
            sg.end_struct(sizeof(physx::PxFrictionPatch));
        }
    };
    physx_PxFrictionPatch_Pod::dump_layout(sg);

    struct physx_PxFrictionAnchorStreamIterator_Pod: public physx::PxFrictionAnchorStreamIterator {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxFrictionAnchorStreamIterator_Pod", "PxFrictionAnchorStreamIterator");
            sg.end_struct(sizeof(physx::PxFrictionAnchorStreamIterator));
        }
    };
    physx_PxFrictionAnchorStreamIterator_Pod::dump_layout(sg);
    ...
    struct physx_PxGpuContactPair_Pod: public physx::PxGpuContactPair {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("uint8_t* frictionPatches", "frictionPatches", "*mut u8", sizeof(uint8_t*), unsafe_offsetof(physx_PxGpuContactPair_Pod, frictionPatches));
    ...
    sg.pass_thru("struct physx_PxDeformableBody_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableSurface_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableMaterial_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableSurfaceMaterial_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableVolume_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxDeformableVolumeMaterial_Pod {\n    void* vtable_;\n};\n");
    ...
    struct physx_PxParticleBuffer_Pod: public physx::PxParticleBuffer {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("void* userData", "userData", "*mut std::ffi::c_void", sizeof(void*), unsafe_offsetof(physx_PxParticleBuffer_Pod, userData));
    ...
    sg.pass_thru("struct physx_PxParticleAndDiffuseBuffer_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxPBDMaterial_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxDeformableAttachmentData_Pod: public physx::PxDeformableAttachmentData {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableAttachmentData_Pod", "PxDeformableAttachmentData");
            sg.add_field("physx_PxActor_Pod* actor[2]", "actor", "[*mut PxActor; 2]", sizeof(physx::PxActor*[2]), unsafe_offsetof(physx_PxDeformableAttachmentData_Pod, actor));
            sg.add_field("int32_t type[2]", "type_", "[PxDeformableAttachmentTargetType; 2]", sizeof(physx::PxDeformableAttachmentTargetType::Enum[2]), unsafe_offsetof(physx_PxDeformableAttachmentData_Pod, type));
            sg.add_field("physx_PxTransform_Pod pose[2]", "pose", "[PxTransform; 2]", sizeof(physx::PxTransform[2]), unsafe_offsetof(physx_PxDeformableAttachmentData_Pod, pose));
            sg.end_struct(sizeof(physx::PxDeformableAttachmentData));
        }
    };
    physx_PxDeformableAttachmentData_Pod::dump_layout(sg);

    struct physx_PxDeformableAttachment_Pod: public physx::PxDeformableAttachment {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableAttachment_Pod", "PxDeformableAttachment");
            sg.add_field("void* userData", "userData", "*mut std::ffi::c_void", sizeof(void*), unsafe_offsetof(physx_PxDeformableAttachment_Pod, userData));
            sg.end_struct(sizeof(physx::PxDeformableAttachment));
        }
    };
    physx_PxDeformableAttachment_Pod::dump_layout(sg);

    struct physx_PxDeformableElementFilterData_Pod: public physx::PxDeformableElementFilterData {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableElementFilterData_Pod", "PxDeformableElementFilterData");
            sg.add_field("physx_PxActor_Pod* actor[2]", "actor", "[*mut PxActor; 2]", sizeof(physx::PxActor*[2]), unsafe_offsetof(physx_PxDeformableElementFilterData_Pod, actor));
            sg.end_struct(sizeof(physx::PxDeformableElementFilterData));
        }
    };
    physx_PxDeformableElementFilterData_Pod::dump_layout(sg);

    struct physx_PxDeformableElementFilter_Pod: public physx::PxDeformableElementFilter {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableElementFilter_Pod", "PxDeformableElementFilter");
            sg.add_field("void* userData", "userData", "*mut std::ffi::c_void", sizeof(void*), unsafe_offsetof(physx_PxDeformableElementFilter_Pod, userData));
            sg.end_struct(sizeof(physx::PxDeformableElementFilter));
        }
    };
    physx_PxDeformableElementFilter_Pod::dump_layout(sg);
    ...
    sg.pass_thru("struct physx_PxRigidDynamic_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxRigidStatic_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxArticulationGPUAPIMaxCounts_Pod: public physx::PxArticulationGPUAPIMaxCounts {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxArticulationGPUAPIMaxCounts_Pod", "PxArticulationGPUAPIMaxCounts");
            sg.add_field("uint32_t maxDofs", "maxDofs", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxDofs));
            sg.add_field("uint32_t maxLinks", "maxLinks", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxLinks));
            sg.add_field("uint32_t maxFixedTendons", "maxFixedTendons", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxFixedTendons));
            sg.add_field("uint32_t maxFixedTendonJoints", "maxFixedTendonJoints", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxFixedTendonJoints));
            sg.add_field("uint32_t maxSpatialTendons", "maxSpatialTendons", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxSpatialTendons));
            sg.add_field("uint32_t maxSpatialTendonAttachments", "maxSpatialTendonAttachments", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxArticulationGPUAPIMaxCounts_Pod, maxSpatialTendonAttachments));
            sg.end_struct(sizeof(physx::PxArticulationGPUAPIMaxCounts));
        }
    };
    physx_PxArticulationGPUAPIMaxCounts_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxDirectGPUAPI_Pod {\n    void* vtable_;\n};\n");
    ...
    struct physx_PxGpuBroadPhaseDesc_Pod: public physx::PxGpuBroadPhaseDesc {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxGpuBroadPhaseDesc_Pod", "PxGpuBroadPhaseDesc");
            sg.add_field("uint8_t gpuBroadPhaseNbBitsShiftX", "gpuBroadPhaseNbBitsShiftX", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsShiftX));
            sg.add_field("uint8_t gpuBroadPhaseNbBitsShiftY", "gpuBroadPhaseNbBitsShiftY", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsShiftY));
            sg.add_field("uint8_t gpuBroadPhaseNbBitsShiftZ", "gpuBroadPhaseNbBitsShiftZ", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsShiftZ));
            sg.add_field("uint8_t gpuBroadPhaseNbBitsEnvIDX", "gpuBroadPhaseNbBitsEnvIDX", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsEnvIDX));
            sg.add_field("uint8_t gpuBroadPhaseNbBitsEnvIDY", "gpuBroadPhaseNbBitsEnvIDY", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsEnvIDY));
            sg.add_field("uint8_t gpuBroadPhaseNbBitsEnvIDZ", "gpuBroadPhaseNbBitsEnvIDZ", "u8", sizeof(uint8_t), unsafe_offsetof(physx_PxGpuBroadPhaseDesc_Pod, gpuBroadPhaseNbBitsEnvIDZ));
            sg.end_struct(sizeof(physx::PxGpuBroadPhaseDesc));
        }
    };
    physx_PxGpuBroadPhaseDesc_Pod::dump_layout(sg);
    ...
    sg.pass_thru("struct physx_PxPostSolveCallback_Pod;\n");
    ...
    struct physx_PxGpuDynamicsMemoryConfig_Pod: public physx::PxGpuDynamicsMemoryConfig {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxGpuDynamicsMemoryConfig_Pod", "PxGpuDynamicsMemoryConfig");
            sg.add_field("uint64_t tempBufferCapacity", "tempBufferCapacity", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, tempBufferCapacity));
            sg.add_field("uint32_t maxRigidContactCount", "maxRigidContactCount", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, maxRigidContactCount));
            sg.add_field("uint32_t maxRigidPatchCount", "maxRigidPatchCount", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, maxRigidPatchCount));
            sg.add_field("uint32_t heapCapacity", "heapCapacity", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, heapCapacity));
            sg.add_field("uint32_t foundLostPairsCapacity", "foundLostPairsCapacity", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, foundLostPairsCapacity));
            sg.add_field("uint32_t foundLostAggregatePairsCapacity", "foundLostAggregatePairsCapacity", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, foundLostAggregatePairsCapacity));
            sg.add_field("uint32_t totalAggregatePairsCapacity", "totalAggregatePairsCapacity", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, totalAggregatePairsCapacity));
            sg.add_field("uint32_t maxDeformableSurfaceContacts", "maxDeformableSurfaceContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, maxDeformableSurfaceContacts));
            sg.add_field("uint32_t maxDeformableVolumeContacts", "maxDeformableVolumeContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, maxDeformableVolumeContacts));
            sg.add_field("uint32_t maxParticleContacts", "maxParticleContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, maxParticleContacts));
            sg.add_field("uint32_t collisionStackSize", "collisionStackSize", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfig_Pod, collisionStackSize));
            sg.end_struct(sizeof(physx::PxGpuDynamicsMemoryConfig));
        }
    };
    physx_PxGpuDynamicsMemoryConfig_Pod::dump_layout(sg);
    ...
    struct physx_PxSceneDesc_Pod: public physx::PxSceneDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxPostSolveCallback_Pod* deformableSurfacePostSolveCallback", "deformableSurfacePostSolveCallback", "*mut PxPostSolveCallback", sizeof(physx::PxPostSolveCallback*), unsafe_offsetof(physx_PxSceneDesc_Pod, deformableSurfacePostSolveCallback));
            sg.add_field("physx_PxPostSolveCallback_Pod* deformableVolumePostSolveCallback", "deformableVolumePostSolveCallback", "*mut PxPostSolveCallback", sizeof(physx::PxPostSolveCallback*), unsafe_offsetof(physx_PxSceneDesc_Pod, deformableVolumePostSolveCallback));
            ...
            sg.add_field("physx_PxGpuBroadPhaseDesc_Pod* gpuBroadPhaseDesc", "gpuBroadPhaseDesc", "*mut PxGpuBroadPhaseDesc", sizeof(physx::PxGpuBroadPhaseDesc*), unsafe_offsetof(physx_PxSceneDesc_Pod, gpuBroadPhaseDesc));
            ...
            sg.add_field("physx_PxGpuDynamicsMemoryConfig_Pod gpuDynamicsConfig", "gpuDynamicsConfig", "PxGpuDynamicsMemoryConfig", sizeof(physx::PxGpuDynamicsMemoryConfig), unsafe_offsetof(physx_PxSceneDesc_Pod, gpuDynamicsConfig));
    ...
    struct physx_PxGpuDynamicsMemoryConfigStatistics_Pod: public physx::PxGpuDynamicsMemoryConfigStatistics {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxGpuDynamicsMemoryConfigStatistics_Pod", "PxGpuDynamicsMemoryConfigStatistics");
            sg.add_field("uint64_t tempBufferCapacity", "tempBufferCapacity", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, tempBufferCapacity));
            sg.add_field("uint32_t rigidContactCount", "rigidContactCount", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, rigidContactCount));
            sg.add_field("uint32_t rigidPatchCount", "rigidPatchCount", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, rigidPatchCount));
            sg.add_field("uint32_t foundLostPairs", "foundLostPairs", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, foundLostPairs));
            sg.add_field("uint32_t foundLostAggregatePairs", "foundLostAggregatePairs", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, foundLostAggregatePairs));
            sg.add_field("uint32_t totalAggregatePairs", "totalAggregatePairs", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, totalAggregatePairs));
            sg.add_field("uint32_t deformableSurfaceContacts", "deformableSurfaceContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, deformableSurfaceContacts));
            sg.add_field("uint32_t deformableVolumeContacts", "deformableVolumeContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, deformableVolumeContacts));
            sg.add_field("uint32_t softbodyContacts", "softbodyContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, softbodyContacts));
            sg.add_field("uint32_t particleContacts", "particleContacts", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, particleContacts));
            sg.add_field("uint32_t collisionStackSize", "collisionStackSize", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxGpuDynamicsMemoryConfigStatistics_Pod, collisionStackSize));
            sg.end_struct(sizeof(physx::PxGpuDynamicsMemoryConfigStatistics));
        }
    };
    physx_PxGpuDynamicsMemoryConfigStatistics_Pod::dump_layout(sg);
    ...
    struct physx_PxSimulationStatistics_Pod: public physx::PxSimulationStatistics {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("uint64_t gpuMemDeformableSurfaces", "gpuMemDeformableSurfaces", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemDeformableSurfaces));
            sg.add_field("uint64_t gpuMemDeformableVolumes", "gpuMemDeformableVolumes", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemDeformableVolumes));
            ...
            sg.add_field("uint64_t gpuMemHeapSimulationDeformableSurface", "gpuMemHeapSimulationDeformableSurface", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemHeapSimulationDeformableSurface));
            sg.add_field("uint64_t gpuMemHeapSimulationDeformableVolume", "gpuMemHeapSimulationDeformableVolume", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemHeapSimulationDeformableVolume));
            ...
            sg.add_field("uint64_t gpuMemHeapDeformableSurfaces", "gpuMemHeapDeformableSurfaces", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemHeapDeformableSurfaces));
            sg.add_field("uint64_t gpuMemHeapDeformableVolumes", "gpuMemHeapDeformableVolumes", "u64", sizeof(uint64_t), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuMemHeapDeformableVolumes));
            ...
            sg.add_field("physx_PxGpuDynamicsMemoryConfigStatistics_Pod gpuDynamicsMemoryConfigStatistics", "gpuDynamicsMemoryConfigStatistics", "PxGpuDynamicsMemoryConfigStatistics", sizeof(physx::PxGpuDynamicsMemoryConfigStatistics), unsafe_offsetof(physx_PxSimulationStatistics_Pod, gpuDynamicsMemoryConfigStatistics));
    ...
    struct physx_PxContactPairFrictionAnchor_Pod: public physx::PxContactPairFrictionAnchor {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxContactPairFrictionAnchor_Pod", "PxContactPairFrictionAnchor");
            sg.add_field("physx_PxVec3_Pod position", "position", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxContactPairFrictionAnchor_Pod, position));
            sg.add_field("physx_PxVec3_Pod impulse", "impulse", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxContactPairFrictionAnchor_Pod, impulse));
            sg.end_struct(sizeof(physx::PxContactPairFrictionAnchor));
        }
    };
    physx_PxContactPairFrictionAnchor_Pod::dump_layout(sg);
    ...
    struct physx_PxContactPair_Pod: public physx::PxContactPair {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("uint8_t const* frictionPatches", "frictionPatches", "*const u8", sizeof(uint8_t const*), unsafe_offsetof(physx_PxContactPair_Pod, frictionPatches));
    ...
    struct physx_PxObstacle_Pod: public physx::PxObstacle {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxVec3T<double>_Pod mPos", "mPos", "PxVec3T<double>", sizeof(physx::PxVec3T<double>), unsafe_offsetof(physx_PxObstacle_Pod, mPos));
    ...
    struct physx_PxControllerHit_Pod: public physx::PxControllerHit {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxVec3T<double>_Pod worldPos", "worldPos", "PxVec3T<double>", sizeof(physx::PxVec3T<double>), unsafe_offsetof(physx_PxControllerHit_Pod, worldPos));
    ...
    struct physx_PxControllerDesc_Pod: public physx::PxControllerDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxVec3T<double>_Pod position", "position", "PxVec3T<double>", sizeof(physx::PxVec3T<double>), unsafe_offsetof(physx_PxControllerDesc_Pod, position));
    ...
    sg.pass_thru("struct physx_PxControllerBehaviorCallback_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxControllerManager_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxSDFBuilder_Pod;\n");
    ...
    struct physx_PxSDFDesc_Pod: public physx::PxSDFDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxSimpleTriangleMesh_Pod baseMesh", "baseMesh", "PxSimpleTriangleMesh", sizeof(physx::PxSimpleTriangleMesh), unsafe_offsetof(physx_PxSDFDesc_Pod, baseMesh));
            sg.add_field("physx_PxSDFBuilder_Pod* sdfBuilder", "sdfBuilder", "*mut PxSDFBuilder", sizeof(physx::PxSDFBuilder*), unsafe_offsetof(physx_PxSDFDesc_Pod, sdfBuilder));
    ...
    struct physx_PxTriangleMeshDesc_Pod: public physx::PxTriangleMeshDesc {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("float geomEpsilon", "geomEpsilon", "f32", sizeof(float), unsafe_offsetof(physx_PxTriangleMeshDesc_Pod, geomEpsilon));
    ...
    struct physx_PxDeformableVolumeSimulationDataDesc_Pod: public physx::PxDeformableVolumeSimulationDataDesc {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableVolumeSimulationDataDesc_Pod", "PxDeformableVolumeSimulationDataDesc");
            sg.add_field("physx_PxBoundedData_Pod vertexToTet", "vertexToTet", "PxBoundedData", sizeof(physx::PxBoundedData), unsafe_offsetof(physx_PxDeformableVolumeSimulationDataDesc_Pod, vertexToTet));
            sg.end_struct(sizeof(physx::PxDeformableVolumeSimulationDataDesc));
        }
    };
    physx_PxDeformableVolumeSimulationDataDesc_Pod::dump_layout(sg);

    struct physx_PxBVH33MidphaseDesc_Pod: public physx::PxBVH33MidphaseDesc {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxBVH33MidphaseDesc_Pod", "PxBVH33MidphaseDesc");
            sg.add_field("float meshSizePerformanceTradeOff", "meshSizePerformanceTradeOff", "f32", sizeof(float), unsafe_offsetof(physx_PxBVH33MidphaseDesc_Pod, meshSizePerformanceTradeOff));
            sg.add_field("int32_t meshCookingHint", "meshCookingHint", "PxMeshCookingHint", sizeof(physx::PxMeshCookingHint::Enum), unsafe_offsetof(physx_PxBVH33MidphaseDesc_Pod, meshCookingHint));
            sg.end_struct(sizeof(physx::PxBVH33MidphaseDesc));
        }
    };
    physx_PxBVH33MidphaseDesc_Pod::dump_layout(sg);
    ...
    struct physx_PxCookingParams_Pod: public physx::PxCookingParams {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("float meshAreaMinLimit", "meshAreaMinLimit", "f32", sizeof(float), unsafe_offsetof(physx_PxCookingParams_Pod, meshAreaMinLimit));
            sg.add_field("float meshEdgeLengthMaxLimit", "meshEdgeLengthMaxLimit", "f32", sizeof(float), unsafe_offsetof(physx_PxCookingParams_Pod, meshEdgeLengthMaxLimit));
    ...
    struct physx_PxConvexCoreExt_Pod: public physx::PxConvexCoreExt {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxConvexCoreExt_Pod", "PxConvexCoreExt");
            sg.end_struct(sizeof(physx::PxConvexCoreExt));
        }
    };
    physx_PxConvexCoreExt_Pod::dump_layout(sg);
    ...
    struct physx_PxBatchQueryStatus_Pod: public physx::PxBatchQueryStatus {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxBatchQueryStatus_Pod", "PxBatchQueryStatus");
            sg.end_struct(sizeof(physx::PxBatchQueryStatus));
        }
    };
    physx_PxBatchQueryStatus_Pod::dump_layout(sg);
    ...
    struct physx_PxGjkQuery_Pod: public physx::PxGjkQuery {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxGjkQuery_Pod", "PxGjkQuery");
            sg.end_struct(sizeof(physx::PxGjkQuery));
        }
    };
    physx_PxGjkQuery_Pod::dump_layout(sg);

    struct physx_PxCustomGeometryExt_Pod: public physx::PxCustomGeometryExt {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxCustomGeometryExt_Pod", "PxCustomGeometryExt");
            sg.end_struct(sizeof(physx::PxCustomGeometryExt));
        }
    };
    physx_PxCustomGeometryExt_Pod::dump_layout(sg);

    struct physx_PxDeformableSurfaceExt_Pod: public physx::PxDeformableSurfaceExt {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxDeformableSurfaceExt_Pod", "PxDeformableSurfaceExt");
            sg.end_struct(sizeof(physx::PxDeformableSurfaceExt));
        }
    };
    physx_PxDeformableSurfaceExt_Pod::dump_layout(sg);
    ...
    struct physx_PxRepXInstantiationArgs_Pod: public physx::PxRepXInstantiationArgs {
        static void dump_layout(PodStructGen& sg) {
            ...
            sg.add_field("physx_PxCookingParams_Pod const* cooker", "cooker", "*const PxCookingParams", sizeof(physx::PxCookingParams const*), unsafe_offsetof(physx_PxRepXInstantiationArgs_Pod, cooker));
    ...
    sg.pass_thru("struct physx_PxRepXSerializer_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleSimulationContext_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleComponent_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxVehicleComponentSequence_Pod: public physx::PxVehicleComponentSequence {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleComponentSequence_Pod", "PxVehicleComponentSequence");
            sg.end_struct(sizeof(physx::PxVehicleComponentSequence));
        }
    };
    physx_PxVehicleComponentSequence_Pod::dump_layout(sg);

    struct physx_PxVehicleAxleDescription_Pod: public physx::PxVehicleAxleDescription {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAxleDescription_Pod", "PxVehicleAxleDescription");
            sg.add_field("uint32_t nbAxles", "nbAxles", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleAxleDescription_Pod, nbAxles));
            sg.add_field("uint32_t nbWheelsPerAxle[20]", "nbWheelsPerAxle", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleAxleDescription_Pod, nbWheelsPerAxle));
            sg.add_field("uint32_t axleToWheelIds[20]", "axleToWheelIds", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleAxleDescription_Pod, axleToWheelIds));
            sg.add_field("uint32_t wheelIdsInAxleOrder[20]", "wheelIdsInAxleOrder", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleAxleDescription_Pod, wheelIdsInAxleOrder));
            sg.add_field("uint32_t nbWheels", "nbWheels", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleAxleDescription_Pod, nbWheels));
            sg.end_struct(sizeof(physx::PxVehicleAxleDescription));
        }
    };
    physx_PxVehicleAxleDescription_Pod::dump_layout(sg);

    struct physx_PxVehicleFrame_Pod: public physx::PxVehicleFrame {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleFrame_Pod", "PxVehicleFrame");
            sg.add_field("int32_t lngAxis", "lngAxis", "PxVehicleAxes", sizeof(physx::PxVehicleAxes::Enum), unsafe_offsetof(physx_PxVehicleFrame_Pod, lngAxis));
            sg.add_field("int32_t latAxis", "latAxis", "PxVehicleAxes", sizeof(physx::PxVehicleAxes::Enum), unsafe_offsetof(physx_PxVehicleFrame_Pod, latAxis));
            sg.add_field("int32_t vrtAxis", "vrtAxis", "PxVehicleAxes", sizeof(physx::PxVehicleAxes::Enum), unsafe_offsetof(physx_PxVehicleFrame_Pod, vrtAxis));
            sg.end_struct(sizeof(physx::PxVehicleFrame));
        }
    };
    physx_PxVehicleFrame_Pod::dump_layout(sg);

    struct physx_PxVehicleScale_Pod: public physx::PxVehicleScale {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleScale_Pod", "PxVehicleScale");
            sg.add_field("float scale", "scale", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleScale_Pod, scale));
            sg.end_struct(sizeof(physx::PxVehicleScale));
        }
    };
    physx_PxVehicleScale_Pod::dump_layout(sg);

    struct physx_PxVehicleTireSlipParams_Pod: public physx::PxVehicleTireSlipParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireSlipParams_Pod", "PxVehicleTireSlipParams");
            sg.add_field("float minLatSlipDenominator", "minLatSlipDenominator", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireSlipParams_Pod, minLatSlipDenominator));
            sg.add_field("float minPassiveLongSlipDenominator", "minPassiveLongSlipDenominator", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireSlipParams_Pod, minPassiveLongSlipDenominator));
            sg.add_field("float minActiveLongSlipDenominator", "minActiveLongSlipDenominator", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireSlipParams_Pod, minActiveLongSlipDenominator));
            sg.end_struct(sizeof(physx::PxVehicleTireSlipParams));
        }
    };
    physx_PxVehicleTireSlipParams_Pod::dump_layout(sg);

    struct physx_PxVehicleTireAxisStickyParams_Pod: public physx::PxVehicleTireAxisStickyParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireAxisStickyParams_Pod", "PxVehicleTireAxisStickyParams");
            sg.add_field("float thresholdSpeed", "thresholdSpeed", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireAxisStickyParams_Pod, thresholdSpeed));
            sg.add_field("float thresholdTime", "thresholdTime", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireAxisStickyParams_Pod, thresholdTime));
            sg.add_field("float damping", "damping", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireAxisStickyParams_Pod, damping));
            sg.end_struct(sizeof(physx::PxVehicleTireAxisStickyParams));
        }
    };
    physx_PxVehicleTireAxisStickyParams_Pod::dump_layout(sg);

    struct physx_PxVehicleTireStickyParams_Pod: public physx::PxVehicleTireStickyParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireStickyParams_Pod", "PxVehicleTireStickyParams");
            sg.add_field("physx_PxVehicleTireAxisStickyParams_Pod stickyParams[2]", "stickyParams", "[PxVehicleTireAxisStickyParams; 2]", sizeof(physx::PxVehicleTireAxisStickyParams[2]), unsafe_offsetof(physx_PxVehicleTireStickyParams_Pod, stickyParams));
            sg.end_struct(sizeof(physx::PxVehicleTireStickyParams));
        }
    };
    physx_PxVehicleTireStickyParams_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehiclePvdAttributeHandles_Pod;\n");
    struct physx_PxVehiclePvdContext_Pod: public physx::PxVehiclePvdContext {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePvdContext_Pod", "PxVehiclePvdContext");
            sg.add_field("physx_PxVehiclePvdAttributeHandles_Pod const* attributeHandles", "attributeHandles", "*const PxVehiclePvdAttributeHandles", sizeof(physx::PxVehiclePvdAttributeHandles const*), unsafe_offsetof(physx_PxVehiclePvdContext_Pod, attributeHandles));
            sg.end_struct(sizeof(physx::PxVehiclePvdContext));
        }
    };
    physx_PxVehiclePvdContext_Pod::dump_layout(sg);

    struct physx_PxVehicleSimulationContext_Pod: public physx::PxVehicleSimulationContext {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSimulationContext_Pod", "PxVehicleSimulationContext");
            sg.add_field("physx_PxVec3_Pod gravity", "gravity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, gravity));
            sg.add_field("physx_PxVehicleFrame_Pod frame", "frame", "PxVehicleFrame", sizeof(physx::PxVehicleFrame), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, frame));
            sg.add_field("physx_PxVehicleScale_Pod scale", "scale", "PxVehicleScale", sizeof(physx::PxVehicleScale), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, scale));
            sg.add_field("physx_PxVehicleTireSlipParams_Pod tireSlipParams", "tireSlipParams", "PxVehicleTireSlipParams", sizeof(physx::PxVehicleTireSlipParams), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, tireSlipParams));
            sg.add_field("physx_PxVehicleTireStickyParams_Pod tireStickyParams", "tireStickyParams", "PxVehicleTireStickyParams", sizeof(physx::PxVehicleTireStickyParams), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, tireStickyParams));
            sg.add_field("float thresholdForwardSpeedForWheelAngleIntegration", "thresholdForwardSpeedForWheelAngleIntegration", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, thresholdForwardSpeedForWheelAngleIntegration));
            sg.add_field("physx_PxVehiclePvdContext_Pod pvdContext", "pvdContext", "PxVehiclePvdContext", sizeof(physx::PxVehiclePvdContext), unsafe_offsetof(physx_PxVehicleSimulationContext_Pod, pvdContext));
            sg.end_struct(sizeof(physx::PxVehicleSimulationContext));
        }
    };
    physx_PxVehicleSimulationContext_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXSimulationContext_Pod: public physx::PxVehiclePhysXSimulationContext {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXSimulationContext_Pod", "PxVehiclePhysXSimulationContext");
            sg.add_field("physx_PxConvexMesh_Pod const* physxUnitCylinderSweepMesh", "physxUnitCylinderSweepMesh", "*const PxConvexMesh", sizeof(physx::PxConvexMesh const*), unsafe_offsetof(physx_PxVehiclePhysXSimulationContext_Pod, physxUnitCylinderSweepMesh));
            sg.add_field("physx_PxScene_Pod const* physxScene", "physxScene", "*const PxScene", sizeof(physx::PxScene const*), unsafe_offsetof(physx_PxVehiclePhysXSimulationContext_Pod, physxScene));
            sg.add_field("int32_t physxActorUpdateMode", "physxActorUpdateMode", "PxVehiclePhysXActorUpdateMode", sizeof(physx::PxVehiclePhysXActorUpdateMode::Enum), unsafe_offsetof(physx_PxVehiclePhysXSimulationContext_Pod, physxActorUpdateMode));
            sg.add_field("float physxActorWakeCounterResetValue", "physxActorWakeCounterResetValue", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXSimulationContext_Pod, physxActorWakeCounterResetValue));
            sg.add_field("float physxActorWakeCounterThreshold", "physxActorWakeCounterThreshold", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXSimulationContext_Pod, physxActorWakeCounterThreshold));
            sg.end_struct(sizeof(physx::PxVehiclePhysXSimulationContext));
        }
    };
    physx_PxVehiclePhysXSimulationContext_Pod::dump_layout(sg);

    struct physx_PxVehicleRoadGeometryState_Pod: public physx::PxVehicleRoadGeometryState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleRoadGeometryState_Pod", "PxVehicleRoadGeometryState");
            sg.add_field("physx_PxPlane_Pod plane", "plane", "PxPlane", sizeof(physx::PxPlane), unsafe_offsetof(physx_PxVehicleRoadGeometryState_Pod, plane));
            sg.add_field("float friction", "friction", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleRoadGeometryState_Pod, friction));
            sg.add_field("physx_PxVec3_Pod velocity", "velocity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRoadGeometryState_Pod, velocity));
            sg.add_field("bool hitState", "hitState", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehicleRoadGeometryState_Pod, hitState));
            sg.end_struct(sizeof(physx::PxVehicleRoadGeometryState));
        }
    };
    physx_PxVehicleRoadGeometryState_Pod::dump_layout(sg);

    struct physx_PxVehicleRigidBodyState_Pod: public physx::PxVehicleRigidBodyState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleRigidBodyState_Pod", "PxVehicleRigidBodyState");
            sg.add_field("physx_PxTransform_Pod pose", "pose", "PxTransform", sizeof(physx::PxTransform), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, pose));
            sg.add_field("physx_PxVec3_Pod linearVelocity", "linearVelocity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, linearVelocity));
            sg.add_field("physx_PxVec3_Pod angularVelocity", "angularVelocity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, angularVelocity));
            sg.add_field("physx_PxVec3_Pod previousLinearVelocity", "previousLinearVelocity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, previousLinearVelocity));
            sg.add_field("physx_PxVec3_Pod previousAngularVelocity", "previousAngularVelocity", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, previousAngularVelocity));
            sg.add_field("physx_PxVec3_Pod externalForce", "externalForce", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, externalForce));
            sg.add_field("physx_PxVec3_Pod externalTorque", "externalTorque", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyState_Pod, externalTorque));
            sg.end_struct(sizeof(physx::PxVehicleRigidBodyState));
        }
    };
    physx_PxVehicleRigidBodyState_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXRoadGeometryQueryState_Pod: public physx::PxVehiclePhysXRoadGeometryQueryState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXRoadGeometryQueryState_Pod", "PxVehiclePhysXRoadGeometryQueryState");
            sg.add_field("physx_PxRigidActor_Pod* actor", "actor", "*mut PxRigidActor", sizeof(physx::PxRigidActor*), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryState_Pod, actor));
            sg.add_field("physx_PxShape_Pod* shape", "shape", "*mut PxShape", sizeof(physx::PxShape*), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryState_Pod, shape));
            sg.add_field("physx_PxMaterial_Pod* material", "material", "*mut PxMaterial", sizeof(physx::PxMaterial*), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryState_Pod, material));
            sg.add_field("physx_PxVec3_Pod hitPosition", "hitPosition", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryState_Pod, hitPosition));
            sg.end_struct(sizeof(physx::PxVehiclePhysXRoadGeometryQueryState));
        }
    };
    physx_PxVehiclePhysXRoadGeometryQueryState_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXActor_Pod: public physx::PxVehiclePhysXActor {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXActor_Pod", "PxVehiclePhysXActor");
            sg.add_field("physx_PxRigidBody_Pod* rigidBody", "rigidBody", "*mut PxRigidBody", sizeof(physx::PxRigidBody*), unsafe_offsetof(physx_PxVehiclePhysXActor_Pod, rigidBody));
            sg.add_field("physx_PxShape_Pod* wheelShapes[20]", "wheelShapes", "[*mut PxShape; 20]", sizeof(physx::PxShape*[20]), unsafe_offsetof(physx_PxVehiclePhysXActor_Pod, wheelShapes));
            sg.end_struct(sizeof(physx::PxVehiclePhysXActor));
        }
    };
    physx_PxVehiclePhysXActor_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXSteerState_Pod: public physx::PxVehiclePhysXSteerState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXSteerState_Pod", "PxVehiclePhysXSteerState");
            sg.add_field("float previousSteerCommand", "previousSteerCommand", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXSteerState_Pod, previousSteerCommand));
            sg.end_struct(sizeof(physx::PxVehiclePhysXSteerState));
        }
    };
    physx_PxVehiclePhysXSteerState_Pod::dump_layout(sg);

    struct physx_PxVehicleVectorN_Pod: public physx::PxVehicleVectorN {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleVectorN_Pod", "PxVehicleVectorN");
            sg.end_struct(sizeof(physx::PxVehicleVectorN));
        }
    };
    physx_PxVehicleVectorN_Pod::dump_layout(sg);

    struct physx_PxVehicleMatrixNN_Pod: public physx::PxVehicleMatrixNN {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleMatrixNN_Pod", "PxVehicleMatrixNN");
            sg.add_field("float mValues[23][23]", "mValues", "[[f32; 23]; 23]", sizeof(float[23][23]), unsafe_offsetof(physx_PxVehicleMatrixNN_Pod, mValues));
            sg.add_field("uint32_t mSize", "mSize", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleMatrixNN_Pod, mSize));
            sg.end_struct(sizeof(physx::PxVehicleMatrixNN));
        }
    };
    physx_PxVehicleMatrixNN_Pod::dump_layout(sg);

    struct physx_PxVehicleMatrixNNLUSolver_Pod: public physx::PxVehicleMatrixNNLUSolver {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleMatrixNNLUSolver_Pod", "PxVehicleMatrixNNLUSolver");
            sg.end_struct(sizeof(physx::PxVehicleMatrixNNLUSolver));
        }
    };
    physx_PxVehicleMatrixNNLUSolver_Pod::dump_layout(sg);

    struct physx_PxVehicleMatrixNGaussSeidelSolver_Pod: public physx::PxVehicleMatrixNGaussSeidelSolver {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleMatrixNGaussSeidelSolver_Pod", "PxVehicleMatrixNGaussSeidelSolver");
            sg.end_struct(sizeof(physx::PxVehicleMatrixNGaussSeidelSolver));
        }
    };
    physx_PxVehicleMatrixNGaussSeidelSolver_Pod::dump_layout(sg);

    struct physx_PxVehicleMatrix33Solver_Pod: public physx::PxVehicleMatrix33Solver {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleMatrix33Solver_Pod", "PxVehicleMatrix33Solver");
            sg.end_struct(sizeof(physx::PxVehicleMatrix33Solver));
        }
    };
    physx_PxVehicleMatrix33Solver_Pod::dump_layout(sg);

    struct physx_PxVehicleCommandValueResponseTable_Pod: public physx::PxVehicleCommandValueResponseTable {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleCommandValueResponseTable_Pod", "PxVehicleCommandValueResponseTable");
            sg.add_field("float commandValue", "commandValue", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleCommandValueResponseTable_Pod, commandValue));
            sg.end_struct(sizeof(physx::PxVehicleCommandValueResponseTable));
        }
    };
    physx_PxVehicleCommandValueResponseTable_Pod::dump_layout(sg);

    struct physx_PxVehicleCommandNonLinearResponseParams_Pod: public physx::PxVehicleCommandNonLinearResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleCommandNonLinearResponseParams_Pod", "PxVehicleCommandNonLinearResponseParams");
            sg.add_field("float speedResponses[128]", "speedResponses", "[f32; 128]", sizeof(float[128]), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, speedResponses));
            sg.add_field("uint16_t nbSpeedResponses", "nbSpeedResponses", "u16", sizeof(uint16_t), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, nbSpeedResponses));
            sg.add_field("uint16_t speedResponsesPerCommandValue[8]", "speedResponsesPerCommandValue", "[u16; 8]", sizeof(uint16_t[8]), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, speedResponsesPerCommandValue));
            sg.add_field("uint16_t nbSpeedResponsesPerCommandValue[8]", "nbSpeedResponsesPerCommandValue", "[u16; 8]", sizeof(uint16_t[8]), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, nbSpeedResponsesPerCommandValue));
            sg.add_field("float commandValues[8]", "commandValues", "[f32; 8]", sizeof(float[8]), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, commandValues));
            sg.add_field("uint16_t nbCommandValues", "nbCommandValues", "u16", sizeof(uint16_t), unsafe_offsetof(physx_PxVehicleCommandNonLinearResponseParams_Pod, nbCommandValues));
            sg.end_struct(sizeof(physx::PxVehicleCommandNonLinearResponseParams));
        }
    };
    physx_PxVehicleCommandNonLinearResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleCommandResponseParams_Pod: public physx::PxVehicleCommandResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleCommandResponseParams_Pod", "PxVehicleCommandResponseParams");
            sg.add_field("physx_PxVehicleCommandNonLinearResponseParams_Pod nonlinearResponse", "nonlinearResponse", "PxVehicleCommandNonLinearResponseParams", sizeof(physx::PxVehicleCommandNonLinearResponseParams), unsafe_offsetof(physx_PxVehicleCommandResponseParams_Pod, nonlinearResponse));
            sg.add_field("float wheelResponseMultipliers[20]", "wheelResponseMultipliers", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleCommandResponseParams_Pod, wheelResponseMultipliers));
            sg.add_field("float maxResponse", "maxResponse", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleCommandResponseParams_Pod, maxResponse));
            sg.end_struct(sizeof(physx::PxVehicleCommandResponseParams));
        }
    };
    physx_PxVehicleCommandResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleBrakeCommandResponseParams_Pod: public physx::PxVehicleBrakeCommandResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleBrakeCommandResponseParams_Pod", "PxVehicleBrakeCommandResponseParams");
            sg.end_struct(sizeof(physx::PxVehicleBrakeCommandResponseParams));
        }
    };
    physx_PxVehicleBrakeCommandResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleCommandState_Pod: public physx::PxVehicleCommandState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleCommandState_Pod", "PxVehicleCommandState");
            sg.add_field("float brakes[2]", "brakes", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehicleCommandState_Pod, brakes));
            sg.add_field("uint32_t nbBrakes", "nbBrakes", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleCommandState_Pod, nbBrakes));
            sg.add_field("float throttle", "throttle", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleCommandState_Pod, throttle));
            sg.add_field("float steer", "steer", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleCommandState_Pod, steer));
            sg.end_struct(sizeof(physx::PxVehicleCommandState));
        }
    };
    physx_PxVehicleCommandState_Pod::dump_layout(sg);

    struct physx_PxVehicleDirectDriveTransmissionCommandState_Pod: public physx::PxVehicleDirectDriveTransmissionCommandState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleDirectDriveTransmissionCommandState_Pod", "PxVehicleDirectDriveTransmissionCommandState");
            sg.end_struct(sizeof(physx::PxVehicleDirectDriveTransmissionCommandState));
        }
    };
    physx_PxVehicleDirectDriveTransmissionCommandState_Pod::dump_layout(sg);

    struct physx_PxVehicleEngineDriveTransmissionCommandState_Pod: public physx::PxVehicleEngineDriveTransmissionCommandState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleEngineDriveTransmissionCommandState_Pod", "PxVehicleEngineDriveTransmissionCommandState");
            sg.add_field("float clutch", "clutch", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineDriveTransmissionCommandState_Pod, clutch));
            sg.add_field("uint32_t targetGear", "targetGear", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleEngineDriveTransmissionCommandState_Pod, targetGear));
            sg.end_struct(sizeof(physx::PxVehicleEngineDriveTransmissionCommandState));
        }
    };
    physx_PxVehicleEngineDriveTransmissionCommandState_Pod::dump_layout(sg);

    struct physx_PxVehicleTankDriveTransmissionCommandState_Pod: public physx::PxVehicleTankDriveTransmissionCommandState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTankDriveTransmissionCommandState_Pod", "PxVehicleTankDriveTransmissionCommandState");
            sg.add_field("float thrusts[2]", "thrusts", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehicleTankDriveTransmissionCommandState_Pod, thrusts));
            sg.end_struct(sizeof(physx::PxVehicleTankDriveTransmissionCommandState));
        }
    };
    physx_PxVehicleTankDriveTransmissionCommandState_Pod::dump_layout(sg);

    struct physx_PxVehicleDirectDriveThrottleCommandResponseParams_Pod: public physx::PxVehicleDirectDriveThrottleCommandResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleDirectDriveThrottleCommandResponseParams_Pod", "PxVehicleDirectDriveThrottleCommandResponseParams");
            sg.end_struct(sizeof(physx::PxVehicleDirectDriveThrottleCommandResponseParams));
        }
    };
    physx_PxVehicleDirectDriveThrottleCommandResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleClutchCommandResponseParams_Pod: public physx::PxVehicleClutchCommandResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleClutchCommandResponseParams_Pod", "PxVehicleClutchCommandResponseParams");
            sg.add_field("float maxResponse", "maxResponse", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleClutchCommandResponseParams_Pod, maxResponse));
            sg.end_struct(sizeof(physx::PxVehicleClutchCommandResponseParams));
        }
    };
    physx_PxVehicleClutchCommandResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleClutchParams_Pod: public physx::PxVehicleClutchParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleClutchParams_Pod", "PxVehicleClutchParams");
            sg.add_field("int32_t accuracyMode", "accuracyMode", "PxVehicleClutchAccuracyMode", sizeof(physx::PxVehicleClutchAccuracyMode::Enum), unsafe_offsetof(physx_PxVehicleClutchParams_Pod, accuracyMode));
            sg.add_field("uint32_t estimateIterations", "estimateIterations", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleClutchParams_Pod, estimateIterations));
            sg.end_struct(sizeof(physx::PxVehicleClutchParams));
        }
    };
    physx_PxVehicleClutchParams_Pod::dump_layout(sg);

    struct physx_PxVehicleEngineParams_Pod: public physx::PxVehicleEngineParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleEngineParams_Pod", "PxVehicleEngineParams");
            sg.add_field("float moi", "moi", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, moi));
            sg.add_field("float peakTorque", "peakTorque", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, peakTorque));
            sg.add_field("float idleOmega", "idleOmega", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, idleOmega));
            sg.add_field("float maxOmega", "maxOmega", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, maxOmega));
            sg.add_field("float dampingRateFullThrottle", "dampingRateFullThrottle", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, dampingRateFullThrottle));
            sg.add_field("float dampingRateZeroThrottleClutchEngaged", "dampingRateZeroThrottleClutchEngaged", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, dampingRateZeroThrottleClutchEngaged));
            sg.add_field("float dampingRateZeroThrottleClutchDisengaged", "dampingRateZeroThrottleClutchDisengaged", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineParams_Pod, dampingRateZeroThrottleClutchDisengaged));
            sg.end_struct(sizeof(physx::PxVehicleEngineParams));
        }
    };
    physx_PxVehicleEngineParams_Pod::dump_layout(sg);

    struct physx_PxVehicleGearboxParams_Pod: public physx::PxVehicleGearboxParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleGearboxParams_Pod", "PxVehicleGearboxParams");
            sg.add_field("uint32_t neutralGear", "neutralGear", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleGearboxParams_Pod, neutralGear));
            sg.add_field("float ratios[32]", "ratios", "[f32; 32]", sizeof(float[32]), unsafe_offsetof(physx_PxVehicleGearboxParams_Pod, ratios));
            sg.add_field("float finalRatio", "finalRatio", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleGearboxParams_Pod, finalRatio));
            sg.add_field("uint32_t nbRatios", "nbRatios", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleGearboxParams_Pod, nbRatios));
            sg.add_field("float switchTime", "switchTime", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleGearboxParams_Pod, switchTime));
            sg.end_struct(sizeof(physx::PxVehicleGearboxParams));
        }
    };
    physx_PxVehicleGearboxParams_Pod::dump_layout(sg);

    struct physx_PxVehicleAutoboxParams_Pod: public physx::PxVehicleAutoboxParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAutoboxParams_Pod", "PxVehicleAutoboxParams");
            sg.add_field("float upRatios[32]", "upRatios", "[f32; 32]", sizeof(float[32]), unsafe_offsetof(physx_PxVehicleAutoboxParams_Pod, upRatios));
            sg.add_field("float downRatios[32]", "downRatios", "[f32; 32]", sizeof(float[32]), unsafe_offsetof(physx_PxVehicleAutoboxParams_Pod, downRatios));
            sg.add_field("float latency", "latency", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAutoboxParams_Pod, latency));
            sg.end_struct(sizeof(physx::PxVehicleAutoboxParams));
        }
    };
    physx_PxVehicleAutoboxParams_Pod::dump_layout(sg);

    struct physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod: public physx::PxVehicleFourWheelDriveDifferentialLegacyParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod", "PxVehicleFourWheelDriveDifferentialLegacyParams");
            sg.add_field("uint32_t frontWheelIds[2]", "frontWheelIds", "[u32; 2]", sizeof(uint32_t[2]), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, frontWheelIds));
            sg.add_field("uint32_t rearWheelIds[2]", "rearWheelIds", "[u32; 2]", sizeof(uint32_t[2]), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, rearWheelIds));
            sg.add_field("float frontRearSplit", "frontRearSplit", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, frontRearSplit));
            sg.add_field("float frontNegPosSplit", "frontNegPosSplit", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, frontNegPosSplit));
            sg.add_field("float rearNegPosSplit", "rearNegPosSplit", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, rearNegPosSplit));
            sg.add_field("float centerBias", "centerBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, centerBias));
            sg.add_field("float frontBias", "frontBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, frontBias));
            sg.add_field("float rearBias", "rearBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod, rearBias));
            sg.end_struct(sizeof(physx::PxVehicleFourWheelDriveDifferentialLegacyParams));
        }
    };
    physx_PxVehicleFourWheelDriveDifferentialLegacyParams_Pod::dump_layout(sg);

    struct physx_PxVehicleMultiWheelDriveDifferentialParams_Pod: public physx::PxVehicleMultiWheelDriveDifferentialParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleMultiWheelDriveDifferentialParams_Pod", "PxVehicleMultiWheelDriveDifferentialParams");
            sg.add_field("float torqueRatios[20]", "torqueRatios", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleMultiWheelDriveDifferentialParams_Pod, torqueRatios));
            sg.add_field("float aveWheelSpeedRatios[20]", "aveWheelSpeedRatios", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleMultiWheelDriveDifferentialParams_Pod, aveWheelSpeedRatios));
            sg.end_struct(sizeof(physx::PxVehicleMultiWheelDriveDifferentialParams));
        }
    };
    physx_PxVehicleMultiWheelDriveDifferentialParams_Pod::dump_layout(sg);

    struct physx_PxVehicleFourWheelDriveDifferentialParams_Pod: public physx::PxVehicleFourWheelDriveDifferentialParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleFourWheelDriveDifferentialParams_Pod", "PxVehicleFourWheelDriveDifferentialParams");
            sg.add_field("uint32_t frontWheelIds[2]", "frontWheelIds", "[u32; 2]", sizeof(uint32_t[2]), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, frontWheelIds));
            sg.add_field("uint32_t rearWheelIds[2]", "rearWheelIds", "[u32; 2]", sizeof(uint32_t[2]), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, rearWheelIds));
            sg.add_field("float frontBias", "frontBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, frontBias));
            sg.add_field("float frontTarget", "frontTarget", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, frontTarget));
            sg.add_field("float rearBias", "rearBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, rearBias));
            sg.add_field("float rearTarget", "rearTarget", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, rearTarget));
            sg.add_field("float centerBias", "centerBias", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, centerBias));
            sg.add_field("float centerTarget", "centerTarget", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, centerTarget));
            sg.add_field("float rate", "rate", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleFourWheelDriveDifferentialParams_Pod, rate));
            sg.end_struct(sizeof(physx::PxVehicleFourWheelDriveDifferentialParams));
        }
    };
    physx_PxVehicleFourWheelDriveDifferentialParams_Pod::dump_layout(sg);

    struct physx_PxVehicleTankDriveDifferentialParams_Pod: public physx::PxVehicleTankDriveDifferentialParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTankDriveDifferentialParams_Pod", "PxVehicleTankDriveDifferentialParams");
            sg.add_field("uint32_t nbTracks", "nbTracks", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleTankDriveDifferentialParams_Pod, nbTracks));
            sg.add_field("uint32_t thrustIdPerTrack[20]", "thrustIdPerTrack", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleTankDriveDifferentialParams_Pod, thrustIdPerTrack));
            sg.add_field("uint32_t nbWheelsPerTrack[20]", "nbWheelsPerTrack", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleTankDriveDifferentialParams_Pod, nbWheelsPerTrack));
            sg.add_field("uint32_t trackToWheelIds[20]", "trackToWheelIds", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleTankDriveDifferentialParams_Pod, trackToWheelIds));
            sg.add_field("uint32_t wheelIdsInTrackOrder[20]", "wheelIdsInTrackOrder", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleTankDriveDifferentialParams_Pod, wheelIdsInTrackOrder));
            sg.end_struct(sizeof(physx::PxVehicleTankDriveDifferentialParams));
        }
    };
    physx_PxVehicleTankDriveDifferentialParams_Pod::dump_layout(sg);

    struct physx_PxVehicleClutchCommandResponseState_Pod: public physx::PxVehicleClutchCommandResponseState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleClutchCommandResponseState_Pod", "PxVehicleClutchCommandResponseState");
            sg.add_field("float normalisedCommandResponse", "normalisedCommandResponse", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleClutchCommandResponseState_Pod, normalisedCommandResponse));
            sg.add_field("float commandResponse", "commandResponse", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleClutchCommandResponseState_Pod, commandResponse));
            sg.end_struct(sizeof(physx::PxVehicleClutchCommandResponseState));
        }
    };
    physx_PxVehicleClutchCommandResponseState_Pod::dump_layout(sg);

    struct physx_PxVehicleEngineDriveThrottleCommandResponseState_Pod: public physx::PxVehicleEngineDriveThrottleCommandResponseState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleEngineDriveThrottleCommandResponseState_Pod", "PxVehicleEngineDriveThrottleCommandResponseState");
            sg.add_field("float commandResponse", "commandResponse", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineDriveThrottleCommandResponseState_Pod, commandResponse));
            sg.end_struct(sizeof(physx::PxVehicleEngineDriveThrottleCommandResponseState));
        }
    };
    physx_PxVehicleEngineDriveThrottleCommandResponseState_Pod::dump_layout(sg);

    struct physx_PxVehicleEngineState_Pod: public physx::PxVehicleEngineState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleEngineState_Pod", "PxVehicleEngineState");
            sg.add_field("float rotationSpeed", "rotationSpeed", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleEngineState_Pod, rotationSpeed));
            sg.end_struct(sizeof(physx::PxVehicleEngineState));
        }
    };
    physx_PxVehicleEngineState_Pod::dump_layout(sg);

    struct physx_PxVehicleGearboxState_Pod: public physx::PxVehicleGearboxState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleGearboxState_Pod", "PxVehicleGearboxState");
            sg.add_field("uint32_t currentGear", "currentGear", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleGearboxState_Pod, currentGear));
            sg.add_field("uint32_t targetGear", "targetGear", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleGearboxState_Pod, targetGear));
            sg.add_field("float gearSwitchTime", "gearSwitchTime", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleGearboxState_Pod, gearSwitchTime));
            sg.end_struct(sizeof(physx::PxVehicleGearboxState));
        }
    };
    physx_PxVehicleGearboxState_Pod::dump_layout(sg);

    struct physx_PxVehicleAutoboxState_Pod: public physx::PxVehicleAutoboxState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAutoboxState_Pod", "PxVehicleAutoboxState");
            sg.add_field("float timeSinceLastShift", "timeSinceLastShift", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAutoboxState_Pod, timeSinceLastShift));
            sg.add_field("bool activeAutoboxGearShift", "activeAutoboxGearShift", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehicleAutoboxState_Pod, activeAutoboxGearShift));
            sg.end_struct(sizeof(physx::PxVehicleAutoboxState));
        }
    };
    physx_PxVehicleAutoboxState_Pod::dump_layout(sg);

    struct physx_PxVehicleDifferentialState_Pod: public physx::PxVehicleDifferentialState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleDifferentialState_Pod", "PxVehicleDifferentialState");
            sg.add_field("uint32_t connectedWheels[20]", "connectedWheels", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleDifferentialState_Pod, connectedWheels));
            sg.add_field("uint32_t nbConnectedWheels", "nbConnectedWheels", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleDifferentialState_Pod, nbConnectedWheels));
            sg.add_field("float torqueRatiosAllWheels[20]", "torqueRatiosAllWheels", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleDifferentialState_Pod, torqueRatiosAllWheels));
            sg.add_field("float aveWheelSpeedContributionAllWheels[20]", "aveWheelSpeedContributionAllWheels", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleDifferentialState_Pod, aveWheelSpeedContributionAllWheels));
            sg.end_struct(sizeof(physx::PxVehicleDifferentialState));
        }
    };
    physx_PxVehicleDifferentialState_Pod::dump_layout(sg);

    struct physx_PxVehicleWheelConstraintGroupState_Pod: public physx::PxVehicleWheelConstraintGroupState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleWheelConstraintGroupState_Pod", "PxVehicleWheelConstraintGroupState");
            sg.add_field("uint32_t nbGroups", "nbGroups", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, nbGroups));
            sg.add_field("uint32_t nbWheelsPerGroup[20]", "nbWheelsPerGroup", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, nbWheelsPerGroup));
            sg.add_field("uint32_t groupToWheelIds[20]", "groupToWheelIds", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, groupToWheelIds));
            sg.add_field("uint32_t wheelIdsInGroupOrder[20]", "wheelIdsInGroupOrder", "[u32; 20]", sizeof(uint32_t[20]), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, wheelIdsInGroupOrder));
            sg.add_field("float wheelMultipliersInGroupOrder[20]", "wheelMultipliersInGroupOrder", "[f32; 20]", sizeof(float[20]), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, wheelMultipliersInGroupOrder));
            sg.add_field("uint32_t nbWheelsInGroups", "nbWheelsInGroups", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleWheelConstraintGroupState_Pod, nbWheelsInGroups));
            sg.end_struct(sizeof(physx::PxVehicleWheelConstraintGroupState));
        }
    };
    physx_PxVehicleWheelConstraintGroupState_Pod::dump_layout(sg);

    struct physx_PxVehicleClutchSlipState_Pod: public physx::PxVehicleClutchSlipState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleClutchSlipState_Pod", "PxVehicleClutchSlipState");
            sg.add_field("float clutchSlip", "clutchSlip", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleClutchSlipState_Pod, clutchSlip));
            sg.end_struct(sizeof(physx::PxVehicleClutchSlipState));
        }
    };
    physx_PxVehicleClutchSlipState_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehicleWheelRigidBody1dState_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleWheelActuationState_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleWheelParams_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleTireForce_Pod;\n");
    struct physx_PxVehicleSteerCommandResponseParams_Pod: public physx::PxVehicleSteerCommandResponseParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSteerCommandResponseParams_Pod", "PxVehicleSteerCommandResponseParams");
            sg.end_struct(sizeof(physx::PxVehicleSteerCommandResponseParams));
        }
    };
    physx_PxVehicleSteerCommandResponseParams_Pod::dump_layout(sg);

    struct physx_PxVehicleAckermannParams_Pod: public physx::PxVehicleAckermannParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAckermannParams_Pod", "PxVehicleAckermannParams");
            sg.add_field("uint32_t wheelIds[2]", "wheelIds", "[u32; 2]", sizeof(uint32_t[2]), unsafe_offsetof(physx_PxVehicleAckermannParams_Pod, wheelIds));
            sg.add_field("float wheelBase", "wheelBase", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAckermannParams_Pod, wheelBase));
            sg.add_field("float trackWidth", "trackWidth", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAckermannParams_Pod, trackWidth));
            sg.add_field("float strength", "strength", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAckermannParams_Pod, strength));
            sg.end_struct(sizeof(physx::PxVehicleAckermannParams));
        }
    };
    physx_PxVehicleAckermannParams_Pod::dump_layout(sg);

    struct physx_PxVehicleWheelActuationState_Pod: public physx::PxVehicleWheelActuationState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleWheelActuationState_Pod", "PxVehicleWheelActuationState");
            sg.add_field("bool isBrakeApplied", "isBrakeApplied", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehicleWheelActuationState_Pod, isBrakeApplied));
            sg.add_field("bool isDriveApplied", "isDriveApplied", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehicleWheelActuationState_Pod, isDriveApplied));
            sg.end_struct(sizeof(physx::PxVehicleWheelActuationState));
        }
    };
    physx_PxVehicleWheelActuationState_Pod::dump_layout(sg);

    struct physx_PxVehicleWheelRigidBody1dState_Pod: public physx::PxVehicleWheelRigidBody1dState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleWheelRigidBody1dState_Pod", "PxVehicleWheelRigidBody1dState");
            sg.add_field("float rotationSpeed", "rotationSpeed", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelRigidBody1dState_Pod, rotationSpeed));
            sg.add_field("float correctedRotationSpeed", "correctedRotationSpeed", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelRigidBody1dState_Pod, correctedRotationSpeed));
            sg.add_field("float rotationAngle", "rotationAngle", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelRigidBody1dState_Pod, rotationAngle));
            sg.end_struct(sizeof(physx::PxVehicleWheelRigidBody1dState));
        }
    };
    physx_PxVehicleWheelRigidBody1dState_Pod::dump_layout(sg);

    struct physx_PxVehicleWheelLocalPose_Pod: public physx::PxVehicleWheelLocalPose {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleWheelLocalPose_Pod", "PxVehicleWheelLocalPose");
            sg.add_field("physx_PxTransform_Pod localPose", "localPose", "PxTransform", sizeof(physx::PxTransform), unsafe_offsetof(physx_PxVehicleWheelLocalPose_Pod, localPose));
            sg.end_struct(sizeof(physx::PxVehicleWheelLocalPose));
        }
    };
    physx_PxVehicleWheelLocalPose_Pod::dump_layout(sg);

    struct physx_PxVehicleWheelParams_Pod: public physx::PxVehicleWheelParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleWheelParams_Pod", "PxVehicleWheelParams");
            sg.add_field("float radius", "radius", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelParams_Pod, radius));
            sg.add_field("float halfWidth", "halfWidth", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelParams_Pod, halfWidth));
            sg.add_field("float mass", "mass", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelParams_Pod, mass));
            sg.add_field("float moi", "moi", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelParams_Pod, moi));
            sg.add_field("float dampingRate", "dampingRate", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleWheelParams_Pod, dampingRate));
            sg.end_struct(sizeof(physx::PxVehicleWheelParams));
        }
    };
    physx_PxVehicleWheelParams_Pod::dump_layout(sg);

    struct physx_PxVehicleTireDirectionState_Pod: public physx::PxVehicleTireDirectionState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireDirectionState_Pod", "PxVehicleTireDirectionState");
            sg.add_field("physx_PxVec3_Pod directions[2]", "directions", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxVehicleTireDirectionState_Pod, directions));
            sg.end_struct(sizeof(physx::PxVehicleTireDirectionState));
        }
    };
    physx_PxVehicleTireDirectionState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireSpeedState_Pod: public physx::PxVehicleTireSpeedState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireSpeedState_Pod", "PxVehicleTireSpeedState");
            sg.add_field("float speedStates[2]", "speedStates", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehicleTireSpeedState_Pod, speedStates));
            sg.end_struct(sizeof(physx::PxVehicleTireSpeedState));
        }
    };
    physx_PxVehicleTireSpeedState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireSlipState_Pod: public physx::PxVehicleTireSlipState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireSlipState_Pod", "PxVehicleTireSlipState");
            sg.add_field("float slips[2]", "slips", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehicleTireSlipState_Pod, slips));
            sg.end_struct(sizeof(physx::PxVehicleTireSlipState));
        }
    };
    physx_PxVehicleTireSlipState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireGripState_Pod: public physx::PxVehicleTireGripState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireGripState_Pod", "PxVehicleTireGripState");
            sg.add_field("float load", "load", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireGripState_Pod, load));
            sg.add_field("float friction", "friction", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireGripState_Pod, friction));
            sg.end_struct(sizeof(physx::PxVehicleTireGripState));
        }
    };
    physx_PxVehicleTireGripState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireCamberAngleState_Pod: public physx::PxVehicleTireCamberAngleState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireCamberAngleState_Pod", "PxVehicleTireCamberAngleState");
            sg.add_field("float camberAngle", "camberAngle", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireCamberAngleState_Pod, camberAngle));
            sg.end_struct(sizeof(physx::PxVehicleTireCamberAngleState));
        }
    };
    physx_PxVehicleTireCamberAngleState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireStickyState_Pod: public physx::PxVehicleTireStickyState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireStickyState_Pod", "PxVehicleTireStickyState");
            sg.add_field("float lowSpeedTime[2]", "lowSpeedTime", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehicleTireStickyState_Pod, lowSpeedTime));
            sg.add_field("bool activeStatus[2]", "activeStatus", "[bool; 2]", sizeof(bool[2]), unsafe_offsetof(physx_PxVehicleTireStickyState_Pod, activeStatus));
            sg.end_struct(sizeof(physx::PxVehicleTireStickyState));
        }
    };
    physx_PxVehicleTireStickyState_Pod::dump_layout(sg);

    struct physx_PxVehicleTireForce_Pod: public physx::PxVehicleTireForce {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireForce_Pod", "PxVehicleTireForce");
            sg.add_field("physx_PxVec3_Pod forces[2]", "forces", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxVehicleTireForce_Pod, forces));
            sg.add_field("physx_PxVec3_Pod torques[2]", "torques", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxVehicleTireForce_Pod, torques));
            sg.add_field("float aligningMoment", "aligningMoment", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForce_Pod, aligningMoment));
            sg.add_field("float wheelTorque", "wheelTorque", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForce_Pod, wheelTorque));
            sg.end_struct(sizeof(physx::PxVehicleTireForce));
        }
    };
    physx_PxVehicleTireForce_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehicleDirectDriveCommandResponseComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleDirectDriveActuationStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleDirectDrivetrainComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleEngineDriveCommandResponseComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleMultiWheelDriveDifferentialStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleFourWheelDriveDifferentialStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleTankDriveDifferentialStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleLegacyFourWheelDriveDifferentialStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleEngineDriveActuationStateComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleEngineDrivetrainComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleRigidBodyParams_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleSuspensionParams_Pod;\n");
    struct physx_PxVehiclePhysXRigidActorParams_Pod: public physx::PxVehiclePhysXRigidActorParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXRigidActorParams_Pod", "PxVehiclePhysXRigidActorParams");
            sg.add_field("char const* physxActorName", "physxActorName", "*const std::ffi::c_char", sizeof(char const*), unsafe_offsetof(physx_PxVehiclePhysXRigidActorParams_Pod, physxActorName));
            sg.end_struct(sizeof(physx::PxVehiclePhysXRigidActorParams));
        }
    };
    physx_PxVehiclePhysXRigidActorParams_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxTransform_Pod;\n");
    struct physx_PxVehiclePhysXRigidActorShapeParams_Pod: public physx::PxVehiclePhysXRigidActorShapeParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXRigidActorShapeParams_Pod", "PxVehiclePhysXRigidActorShapeParams");
            sg.add_field("uint8_t flags", "flags", "PxShapeFlags", sizeof(physx::PxShapeFlags), unsafe_offsetof(physx_PxVehiclePhysXRigidActorShapeParams_Pod, flags));
            sg.add_field("physx_PxFilterData_Pod simulationFilterData", "simulationFilterData", "PxFilterData", sizeof(physx::PxFilterData), unsafe_offsetof(physx_PxVehiclePhysXRigidActorShapeParams_Pod, simulationFilterData));
            sg.add_field("physx_PxFilterData_Pod queryFilterData", "queryFilterData", "PxFilterData", sizeof(physx::PxFilterData), unsafe_offsetof(physx_PxVehiclePhysXRigidActorShapeParams_Pod, queryFilterData));
            sg.end_struct(sizeof(physx::PxVehiclePhysXRigidActorShapeParams));
        }
    };
    physx_PxVehiclePhysXRigidActorShapeParams_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXWheelParams_Pod: public physx::PxVehiclePhysXWheelParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXWheelParams_Pod", "PxVehiclePhysXWheelParams");
            sg.add_field("physx_PxVehicleWheelParams_Pod const* wheelParams", "wheelParams", "*const PxVehicleWheelParams", sizeof(physx::PxVehicleWheelParams const*), unsafe_offsetof(physx_PxVehiclePhysXWheelParams_Pod, wheelParams));
            sg.end_struct(sizeof(physx::PxVehiclePhysXWheelParams));
        }
    };
    physx_PxVehiclePhysXWheelParams_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXWheelShapeParams_Pod: public physx::PxVehiclePhysXWheelShapeParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXWheelShapeParams_Pod", "PxVehiclePhysXWheelShapeParams");
            sg.add_field("uint8_t flags", "flags", "PxShapeFlags", sizeof(physx::PxShapeFlags), unsafe_offsetof(physx_PxVehiclePhysXWheelShapeParams_Pod, flags));
            sg.add_field("physx_PxFilterData_Pod simulationFilterData", "simulationFilterData", "PxFilterData", sizeof(physx::PxFilterData), unsafe_offsetof(physx_PxVehiclePhysXWheelShapeParams_Pod, simulationFilterData));
            sg.add_field("physx_PxFilterData_Pod queryFilterData", "queryFilterData", "PxFilterData", sizeof(physx::PxFilterData), unsafe_offsetof(physx_PxVehiclePhysXWheelShapeParams_Pod, queryFilterData));
            sg.end_struct(sizeof(physx::PxVehiclePhysXWheelShapeParams));
        }
    };
    physx_PxVehiclePhysXWheelShapeParams_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehiclePhysXConstraints_Pod;\n");
    sg.pass_thru("struct physx_PxVehiclePhysXActorBeginComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehiclePhysXActorEndComponent_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxVehiclePhysXSuspensionLimitConstraintParams_Pod: public physx::PxVehiclePhysXSuspensionLimitConstraintParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXSuspensionLimitConstraintParams_Pod", "PxVehiclePhysXSuspensionLimitConstraintParams");
            sg.add_field("float restitution", "restitution", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXSuspensionLimitConstraintParams_Pod, restitution));
            sg.add_field("int32_t directionForSuspensionLimitConstraint", "directionForSuspensionLimitConstraint", "DirectionSpecifier", sizeof(physx::PxVehiclePhysXSuspensionLimitConstraintParams::DirectionSpecifier), unsafe_offsetof(physx_PxVehiclePhysXSuspensionLimitConstraintParams_Pod, directionForSuspensionLimitConstraint));
            sg.end_struct(sizeof(physx::PxVehiclePhysXSuspensionLimitConstraintParams));
        }
    };
    physx_PxVehiclePhysXSuspensionLimitConstraintParams_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXConstraintState_Pod: public physx::PxVehiclePhysXConstraintState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXConstraintState_Pod", "PxVehiclePhysXConstraintState");
            sg.add_field("bool tireActiveStatus[2]", "tireActiveStatus", "[bool; 2]", sizeof(bool[2]), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, tireActiveStatus));
            sg.add_field("physx_PxVec3_Pod tireLinears[2]", "tireLinears", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, tireLinears));
            sg.add_field("physx_PxVec3_Pod tireAngulars[2]", "tireAngulars", "[PxVec3; 2]", sizeof(physx::PxVec3[2]), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, tireAngulars));
            sg.add_field("float tireDamping[2]", "tireDamping", "[f32; 2]", sizeof(float[2]), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, tireDamping));
            sg.add_field("bool suspActiveStatus", "suspActiveStatus", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, suspActiveStatus));
            sg.add_field("physx_PxVec3_Pod suspLinear", "suspLinear", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, suspLinear));
            sg.add_field("physx_PxVec3_Pod suspAngular", "suspAngular", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, suspAngular));
            sg.add_field("float suspGeometricError", "suspGeometricError", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, suspGeometricError));
            sg.add_field("float restitution", "restitution", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXConstraintState_Pod, restitution));
            sg.end_struct(sizeof(physx::PxVehiclePhysXConstraintState));
        }
    };
    physx_PxVehiclePhysXConstraintState_Pod::dump_layout(sg);

    struct physx_PxVehicleConstraintConnector_Pod: public physx::PxVehicleConstraintConnector {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleConstraintConnector_Pod", "PxVehicleConstraintConnector");
            sg.end_struct(sizeof(physx::PxVehicleConstraintConnector));
        }
    };
    physx_PxVehicleConstraintConnector_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXConstraints_Pod: public physx::PxVehiclePhysXConstraints {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXConstraints_Pod", "PxVehiclePhysXConstraints");
            sg.add_field("physx_PxVehiclePhysXConstraintState_Pod constraintStates[20]", "constraintStates", "[PxVehiclePhysXConstraintState; 20]", sizeof(physx::PxVehiclePhysXConstraintState[20]), unsafe_offsetof(physx_PxVehiclePhysXConstraints_Pod, constraintStates));
            sg.add_field("physx_PxConstraint_Pod* constraints[5]", "constraints", "[*mut PxConstraint; 5]", sizeof(physx::PxConstraint*[5]), unsafe_offsetof(physx_PxVehiclePhysXConstraints_Pod, constraints));
            sg.add_field("physx_PxVehicleConstraintConnector_Pod* constraintConnectors[5]", "constraintConnectors", "[*mut PxVehicleConstraintConnector; 5]", sizeof(physx::PxVehicleConstraintConnector*[5]), unsafe_offsetof(physx_PxVehiclePhysXConstraints_Pod, constraintConnectors));
            sg.end_struct(sizeof(physx::PxVehiclePhysXConstraints));
        }
    };
    physx_PxVehiclePhysXConstraints_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehicleSuspensionState_Pod;\n");
    sg.pass_thru("struct physx_PxVehicleSuspensionComplianceState_Pod;\n");
    struct physx_PxVehicleSuspensionParams_Pod: public physx::PxVehicleSuspensionParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionParams_Pod", "PxVehicleSuspensionParams");
            sg.add_field("physx_PxTransform_Pod suspensionAttachment", "suspensionAttachment", "PxTransform", sizeof(physx::PxTransform), unsafe_offsetof(physx_PxVehicleSuspensionParams_Pod, suspensionAttachment));
            sg.add_field("physx_PxVec3_Pod suspensionTravelDir", "suspensionTravelDir", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSuspensionParams_Pod, suspensionTravelDir));
            sg.add_field("float suspensionTravelDist", "suspensionTravelDist", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionParams_Pod, suspensionTravelDist));
            sg.add_field("physx_PxTransform_Pod wheelAttachment", "wheelAttachment", "PxTransform", sizeof(physx::PxTransform), unsafe_offsetof(physx_PxVehicleSuspensionParams_Pod, wheelAttachment));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionParams));
        }
    };
    physx_PxVehicleSuspensionParams_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionStateCalculationParams_Pod: public physx::PxVehicleSuspensionStateCalculationParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionStateCalculationParams_Pod", "PxVehicleSuspensionStateCalculationParams");
            sg.add_field("int32_t suspensionJounceCalculationType", "suspensionJounceCalculationType", "PxVehicleSuspensionJounceCalculationType", sizeof(physx::PxVehicleSuspensionJounceCalculationType::Enum), unsafe_offsetof(physx_PxVehicleSuspensionStateCalculationParams_Pod, suspensionJounceCalculationType));
            sg.add_field("bool limitSuspensionExpansionVelocity", "limitSuspensionExpansionVelocity", "bool", sizeof(bool), unsafe_offsetof(physx_PxVehicleSuspensionStateCalculationParams_Pod, limitSuspensionExpansionVelocity));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionStateCalculationParams));
        }
    };
    physx_PxVehicleSuspensionStateCalculationParams_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionComplianceParams_Pod: public physx::PxVehicleSuspensionComplianceParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionComplianceParams_Pod", "PxVehicleSuspensionComplianceParams");
            sg.end_struct(sizeof(physx::PxVehicleSuspensionComplianceParams));
        }
    };
    physx_PxVehicleSuspensionComplianceParams_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionForceParams_Pod: public physx::PxVehicleSuspensionForceParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionForceParams_Pod", "PxVehicleSuspensionForceParams");
            sg.add_field("float stiffness", "stiffness", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceParams_Pod, stiffness));
            sg.add_field("float damping", "damping", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceParams_Pod, damping));
            sg.add_field("float sprungMass", "sprungMass", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceParams_Pod, sprungMass));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionForceParams));
        }
    };
    physx_PxVehicleSuspensionForceParams_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionForceLegacyParams_Pod: public physx::PxVehicleSuspensionForceLegacyParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionForceLegacyParams_Pod", "PxVehicleSuspensionForceLegacyParams");
            sg.add_field("float stiffness", "stiffness", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceLegacyParams_Pod, stiffness));
            sg.add_field("float damping", "damping", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceLegacyParams_Pod, damping));
            sg.add_field("float restDistance", "restDistance", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceLegacyParams_Pod, restDistance));
            sg.add_field("float sprungMass", "sprungMass", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForceLegacyParams_Pod, sprungMass));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionForceLegacyParams));
        }
    };
    physx_PxVehicleSuspensionForceLegacyParams_Pod::dump_layout(sg);

    struct physx_PxVehicleAntiRollForceParams_Pod: public physx::PxVehicleAntiRollForceParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAntiRollForceParams_Pod", "PxVehicleAntiRollForceParams");
            sg.add_field("uint32_t wheel0", "wheel0", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleAntiRollForceParams_Pod, wheel0));
            sg.add_field("uint32_t wheel1", "wheel1", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehicleAntiRollForceParams_Pod, wheel1));
            sg.add_field("float stiffness", "stiffness", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleAntiRollForceParams_Pod, stiffness));
            sg.end_struct(sizeof(physx::PxVehicleAntiRollForceParams));
        }
    };
    physx_PxVehicleAntiRollForceParams_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionState_Pod: public physx::PxVehicleSuspensionState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionState_Pod", "PxVehicleSuspensionState");
            sg.add_field("float jounce", "jounce", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionState_Pod, jounce));
            sg.add_field("float jounceSpeed", "jounceSpeed", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionState_Pod, jounceSpeed));
            sg.add_field("float separation", "separation", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionState_Pod, separation));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionState));
        }
    };
    physx_PxVehicleSuspensionState_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionComplianceState_Pod: public physx::PxVehicleSuspensionComplianceState {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionComplianceState_Pod", "PxVehicleSuspensionComplianceState");
            sg.add_field("float toe", "toe", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionComplianceState_Pod, toe));
            sg.add_field("float camber", "camber", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionComplianceState_Pod, camber));
            sg.add_field("physx_PxVec3_Pod tireForceAppPoint", "tireForceAppPoint", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSuspensionComplianceState_Pod, tireForceAppPoint));
            sg.add_field("physx_PxVec3_Pod suspForceAppPoint", "suspForceAppPoint", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSuspensionComplianceState_Pod, suspForceAppPoint));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionComplianceState));
        }
    };
    physx_PxVehicleSuspensionComplianceState_Pod::dump_layout(sg);

    struct physx_PxVehicleSuspensionForce_Pod: public physx::PxVehicleSuspensionForce {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleSuspensionForce_Pod", "PxVehicleSuspensionForce");
            sg.add_field("physx_PxVec3_Pod force", "force", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSuspensionForce_Pod, force));
            sg.add_field("physx_PxVec3_Pod torque", "torque", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleSuspensionForce_Pod, torque));
            sg.add_field("float normalForce", "normalForce", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleSuspensionForce_Pod, normalForce));
            sg.end_struct(sizeof(physx::PxVehicleSuspensionForce));
        }
    };
    physx_PxVehicleSuspensionForce_Pod::dump_layout(sg);

    struct physx_PxVehicleAntiRollTorque_Pod: public physx::PxVehicleAntiRollTorque {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleAntiRollTorque_Pod", "PxVehicleAntiRollTorque");
            sg.add_field("physx_PxVec3_Pod antiRollTorque", "antiRollTorque", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleAntiRollTorque_Pod, antiRollTorque));
            sg.end_struct(sizeof(physx::PxVehicleAntiRollTorque));
        }
    };
    physx_PxVehicleAntiRollTorque_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehiclePhysXConstraintComponent_Pod {\n    void* vtable_;\n};\n");
    struct physx_PxVehiclePhysXRoadGeometryQueryParams_Pod: public physx::PxVehiclePhysXRoadGeometryQueryParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXRoadGeometryQueryParams_Pod", "PxVehiclePhysXRoadGeometryQueryParams");
            sg.add_field("physx_PxQueryFilterData_Pod defaultFilterData", "defaultFilterData", "PxQueryFilterData", sizeof(physx::PxQueryFilterData), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryParams_Pod, defaultFilterData));
            sg.add_field("physx_PxQueryFilterData_Pod* filterDataEntries", "filterDataEntries", "*mut PxQueryFilterData", sizeof(physx::PxQueryFilterData*), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryParams_Pod, filterDataEntries));
            sg.add_field("physx_PxQueryFilterCallback_Pod* filterCallback", "filterCallback", "*mut PxQueryFilterCallback", sizeof(physx::PxQueryFilterCallback*), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryParams_Pod, filterCallback));
            sg.add_field("int32_t roadGeometryQueryType", "roadGeometryQueryType", "PxVehiclePhysXRoadGeometryQueryType", sizeof(physx::PxVehiclePhysXRoadGeometryQueryType::Enum), unsafe_offsetof(physx_PxVehiclePhysXRoadGeometryQueryParams_Pod, roadGeometryQueryType));
            sg.end_struct(sizeof(physx::PxVehiclePhysXRoadGeometryQueryParams));
        }
    };
    physx_PxVehiclePhysXRoadGeometryQueryParams_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXMaterialFriction_Pod: public physx::PxVehiclePhysXMaterialFriction {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXMaterialFriction_Pod", "PxVehiclePhysXMaterialFriction");
            sg.add_field("physx_PxMaterial_Pod const* material", "material", "*const PxMaterial", sizeof(physx::PxMaterial const*), unsafe_offsetof(physx_PxVehiclePhysXMaterialFriction_Pod, material));
            sg.add_field("float friction", "friction", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXMaterialFriction_Pod, friction));
            sg.end_struct(sizeof(physx::PxVehiclePhysXMaterialFriction));
        }
    };
    physx_PxVehiclePhysXMaterialFriction_Pod::dump_layout(sg);

    struct physx_PxVehiclePhysXMaterialFrictionParams_Pod: public physx::PxVehiclePhysXMaterialFrictionParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePhysXMaterialFrictionParams_Pod", "PxVehiclePhysXMaterialFrictionParams");
            sg.add_field("physx_PxVehiclePhysXMaterialFriction_Pod* materialFrictions", "materialFrictions", "*mut PxVehiclePhysXMaterialFriction", sizeof(physx::PxVehiclePhysXMaterialFriction*), unsafe_offsetof(physx_PxVehiclePhysXMaterialFrictionParams_Pod, materialFrictions));
            sg.add_field("uint32_t nbMaterialFrictions", "nbMaterialFrictions", "u32", sizeof(uint32_t), unsafe_offsetof(physx_PxVehiclePhysXMaterialFrictionParams_Pod, nbMaterialFrictions));
            sg.add_field("float defaultFriction", "defaultFriction", "f32", sizeof(float), unsafe_offsetof(physx_PxVehiclePhysXMaterialFrictionParams_Pod, defaultFriction));
            sg.end_struct(sizeof(physx::PxVehiclePhysXMaterialFrictionParams));
        }
    };
    physx_PxVehiclePhysXMaterialFrictionParams_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehiclePhysXRoadGeometrySceneQueryComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehiclePvdObjectHandles_Pod;\n");
    struct physx_PxVehicleTireForceParams_Pod: public physx::PxVehicleTireForceParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleTireForceParams_Pod", "PxVehicleTireForceParams");
            sg.add_field("float latStiffX", "latStiffX", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, latStiffX));
            sg.add_field("float latStiffY", "latStiffY", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, latStiffY));
            sg.add_field("float longStiff", "longStiff", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, longStiff));
            sg.add_field("float camberStiff", "camberStiff", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, camberStiff));
            sg.add_field("float frictionVsSlip[3][2]", "frictionVsSlip", "[[f32; 3]; 2]", sizeof(float[3][2]), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, frictionVsSlip));
            sg.add_field("float restLoad", "restLoad", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, restLoad));
            sg.add_field("float loadFilter[2][2]", "loadFilter", "[[f32; 2]; 2]", sizeof(float[2][2]), unsafe_offsetof(physx_PxVehicleTireForceParams_Pod, loadFilter));
            sg.end_struct(sizeof(physx::PxVehicleTireForceParams));
        }
    };
    physx_PxVehicleTireForceParams_Pod::dump_layout(sg);

    struct physx_PxVehiclePVDComponent_Pod: public physx::PxVehiclePVDComponent {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehiclePVDComponent_Pod", "PxVehiclePVDComponent");
            sg.end_struct(sizeof(physx::PxVehiclePVDComponent));
        }
    };
    physx_PxVehiclePVDComponent_Pod::dump_layout(sg);

    struct physx_PxVehicleRigidBodyParams_Pod: public physx::PxVehicleRigidBodyParams {
        static void dump_layout(PodStructGen& sg) {
            sg.begin_struct("physx_PxVehicleRigidBodyParams_Pod", "PxVehicleRigidBodyParams");
            sg.add_field("float mass", "mass", "f32", sizeof(float), unsafe_offsetof(physx_PxVehicleRigidBodyParams_Pod, mass));
            sg.add_field("physx_PxVec3_Pod moi", "moi", "PxVec3", sizeof(physx::PxVec3), unsafe_offsetof(physx_PxVehicleRigidBodyParams_Pod, moi));
            sg.end_struct(sizeof(physx::PxVehicleRigidBodyParams));
        }
    };
    physx_PxVehicleRigidBodyParams_Pod::dump_layout(sg);

    sg.pass_thru("struct physx_PxVehicleRigidBodyComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleSuspensionComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleLegacySuspensionComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleTireComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleLegacyTireComponent_Pod {\n    void* vtable_;\n};\n");
    sg.pass_thru("struct physx_PxVehicleWheelComponent_Pod {\n    void* vtable_;\n};\n");

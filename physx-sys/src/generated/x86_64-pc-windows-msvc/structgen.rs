...
pub struct PxTGSSolverConstraintPrepDescBase {
    ...
    pub bodyFrame0: PxTransform,
    pub bodyFrame1: PxTransform,
    pub bodyState0: PxSolverContactDesc::BodyState,
    pub bodyState1: PxSolverContactDesc::BodyState,
    pub structgen_pad0: [u8; 8],
}
#[derive(Clone, Copy)]
#[cfg_attr(feature = "debug-structs", derive(Debug))]
...
mod sizes {
    ...
    fn check_sizes() {
        ...
        assert_eq!(size_of::<PxReportCallbackBase>(), 16);
        ...
        assert_eq!(size_of::<PxArticulationMimicJoint>(), 24);
        ...
        assert_eq!(size_of::<PxDeformableAttachment>(), 24);
        assert_eq!(size_of::<PxDeformableElementFilterData>(), 80);
        assert_eq!(size_of::<PxDeformableElementFilter>(), 24);
        ...
        assert_eq!(size_of::<PxDefaultMemoryOutputStream>(), 40);
        ...
        assert_eq!(size_of::<PxVehicleConstraintConnector>(), 16);
        ...
        assert_eq!(size_of::<PxVehiclePVDComponent>(), 16);
